  ...
  return (
    <div style={{ minHeight:"100vh", background:C.bg, fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <div style={{ maxWidth:600, margin:"0 auto", padding:"80px 20px", textAlign:"center" }}>
        ...
        <h1 style={{ fontFamily:"Sora,sans-serif", fontSize:32, fontWeight:900, color:C.g800, marginBottom:16 }}>Blog</h1>
        <div style={{ background:C.white, borderRadius:16, padding:32, border:`1px solid ${C.g100}`, boxShadow:"0 4px 20px rgba(0,0,0,0.06)", marginBottom:32 }}>
          <p style={{ fontSize:16, color:C.g600, lineHeight:1.7, marginBottom:24 }}>
            Blog jest w trakcie budowy. Wkrótce pojawią się tutaj artykuły o rynku pracy, stawkach w różnych zawodach i poradniki dla pracowników i pracodawców.
          </p>
          <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
            {[
              "📊 Ile zarabia elektryk w Polsce?",
              "🚚 Stawki kierowców C+E w 2026 roku",
              "🏗️ Najbardziej poszukiwane zawody budowlane",
              "💡 Jak negocjować stawkę godzinową?",
            ].map((item, i) => (
      ...
      <div style={{ background:C.g800, padding:"24px 20px", textAlign:"center" }}>
        <div style={{ fontSize:13, color:C.g400 }}>© 2026 rynekpracownika.pl</div>
      </div>
    </div>
  );
}